...
- **setup-jstack**. Use to put jstack on a machine or bring it up to date. Installs the skills into your harness's skills folder, including the vendored third-party ones, checks every tool the flow expects and offers to install what's missing, installs each tool's own skill, and reports what's still not there.
