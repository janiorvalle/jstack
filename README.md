...
- `tasks/` is this repo's own work tracker, markdown tasks in the shape the `tracker` skill describes, named by the `Tracker:` line at the top of the letter. Setup leaves that line out of what it installs.
